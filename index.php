	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="login/Auth.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Insira a sua password">
					...
					<div class="container-login100-form-btn">
                        <input class="login100-form-btn" style="background-color: #D3e7fb;" type="submit" value="Login" />
					</div>
				</form>
			</div>
		</div>
