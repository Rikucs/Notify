                      ...
                      <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                          ...
                          <li class="nav-item topbar-icon dropdown hidden-caret">
                              ...
                              >
                                  ...
                                  <li>
                                      <a class="see-all" href="notify.php"
                          ...
                          <div class="card-body p-0">
                              <div class="table-responsive">
                                  ...
                                  <table class="table align-items-center mb-0">
                                      ...
                                      <tr>
                                          <th style="text-align: center;" scope="row"><?= $row['notino'] ?></th>
                                          <td style="text-align: center;"><?php $dn =new datetime( $row['data']); echo $dn->format('d-m-Y H:i'); ?></td>
                                          <td style="text-align: center;"><?= $row['usrcode'] ?></td>
                                          ...
                                          <?php } ?>
                                          <?php if ($row['clip'] > 0) { ?>
                                                    <td style="text-align: center;"><img src="assets/img/clip2.png" width="40" height="40"></td>
                                                <?php } else { ?>
                                                    <td style="text-align: center;"></td>
                                                <?php } ?>
                                          <td style="text-align: center;"><?php $dn =new datetime( $row['Data']); echo $dn->format('d-m-Y'); ?></td>
                                          <?php if ($row['status'] > 1) { ?>
                                          <td style="text-align: center;">Lida</td>
                                          <?php }else{ ?>
