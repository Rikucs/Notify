...
if (isset($_POST["submit"])) {
    if ($_POST['mensagem'] != 0 && $_POST['mensagem'] != ''  && isset($_POST['users'])) {
                            ...
                            <ul
                                ...
                                <li>
                                    <div class="dropdown-title">
                                        Tem <span id="notification-count-text"></span> Notificaçoes Novas
                                    </div>
                                </li>
                                <li>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                        ...
                                                        class="form-select"
                                                        >
                                                        <option value ="3">Pergunta</option>
                                                        <option value ="4">Notificação</option>

                                                </select>

                                                <small id="emailHelp2" class="form-text text-muted">Escolha o assunto que representa a sua mensagem</small>
                                            </div>
                                            <div class="form-group">
                                                <label for="mensagem">Mensagem</label>
                                                <textarea name = "mensagem" class="form-control" id="mensagem" rows="7"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="multiselect">Lista de Utilizadores</label>
                                                <select name="users[]"
                                                        id="multiselect"
                                                        class="form-control"
                                                        size="10"
                                                ...
                                                >
                                                    <?php foreach ($user as $row){
                                                            ...
                                                            <option value =' <?php echo $row['USRNO'] ?> '> <?php echo $us ?></option>';
                                            ...
                                            <div class="box">
                                                <label>
                                                    ...
                                                    <span>de um ficheiro ou varios ao mesmo tempo</span>
